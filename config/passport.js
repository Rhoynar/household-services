...
module.exports = function (passport) {
    ...
    passport.use('local-login', new LocalStrategy({
        ...
        function (req, email, password, done) { // callback with email and password from our form
            ...
            Users.findOne({ 'email': email,'role':'user' }, function (err, user) {
    ...
    passport.use('admin-local-login', new LocalStrategy({
        ...
        function (req, email, password, done) { // callback with email and password from our form
            ...
            // find a user whose email is the same as the forms email
            // we are checking to see if the user trying to login already exists
            Users.findOne({ 'email': email,'role':'admin' }, function (err, user) {
                // if there are any errors, return the error before anything else
                if (err)
                    return done(err);
    ...
    passport.use(new GoogleStrategy({
        ...
        callbackURL: process.env.BASE_URL + '/googleloginreturn'
