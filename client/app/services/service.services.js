...
var ServiceServices = (function () {
    function ServiceServices(http) {
        this.http = http;
        console.log('User is initialised');
    }
    ServiceServices.prototype.getHeader = function () {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return headers;
    };
    ServiceServices.prototype.getAllService = function () {
    ...
    ServiceServices.prototype.handleError = function (error) {
